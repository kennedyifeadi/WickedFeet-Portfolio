...
export const AboutMe = () => {
  ...
  return (
    <div className="h-[150dvh] md:h-screen w-full relative z-10 bg-white flex flex-col md:flex-row">
      <div className="flex-1 h-1/2 md:h-full flex justify-center items-center relative">
        <video
          ref={videoRef}
          className="w-[90%] h-[60%] md:h-[50%] object-cover rounded-2xl"
          loop
          muted
          playsInline
          onMouseEnter={() => {
      ...
      <div className="flex-1 h-1/2 md:h-full flex flex-col">
        <div className="flex-1 flex flex-col p-4 justify-center">
          <h2
            className="text-xl md:text-4xl font-bold mb-4 italic"
            style={{ fontFamily: "Oswald" }}
          >
            “Dance is how I turn music into a story.”
          </h2>
          <p className="mb-4 px-2 text-[14px] md:text-[16px]">
